...
mixin _$PurchaseOrder {
 ...
 String get id; String get poNumber; String? get supplierId; String? get supplierName; String get status; bool get blindReceiving; DateTime? get createdAt; List<PoItem> get items;
...
@override
int get hashCode => Object.hash(runtimeType,id,poNumber,supplierId,supplierName,status,blindReceiving,createdAt,const DeepCollectionEquality().hash(items));
...
@useResult
$Res call({
 String id, String poNumber, String? supplierId, String? supplierName, String status, bool blindReceiving, DateTime? createdAt, List<PoItem> items
});
...
/// Create a copy of PurchaseOrder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? poNumber = null,Object? supplierId = freezed,Object? supplierName = freezed,Object? status = null,Object? blindReceiving = null,Object? createdAt = freezed,Object? items = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String poNumber,  String? supplierId,  String? supplierName,  String status,  bool blindReceiving,  DateTime? createdAt,  List<PoItem> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PurchaseOrder() when $default != null:
return $default(_that.id,_that.poNumber,_that.supplierId,_that.supplierName,_that.status,_that.blindReceiving,_that.createdAt,_that.items);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String poNumber,  String? supplierId,  String? supplierName,  String status,  bool blindReceiving,  DateTime? createdAt,  List<PoItem> items)  $default,) {final _that = this;
switch (_that) {
case _PurchaseOrder():
return $default(_that.id,_that.poNumber,_that.supplierId,_that.supplierName,_that.status,_that.blindReceiving,_that.createdAt,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String poNumber,  String? supplierId,  String? supplierName,  String status,  bool blindReceiving,  DateTime? createdAt,  List<PoItem> items)?  $default,) {final _that = this;
switch (_that) {
case _PurchaseOrder() when $default != null:
return $default(_that.id,_that.poNumber,_that.supplierId,_that.supplierName,_that.status,_that.blindReceiving,_that.createdAt,_that.items);case _:
  return null;
...
class _PurchaseOrder implements PurchaseOrder {
  const _PurchaseOrder({required this.id, required this.poNumber, this.supplierId, this.supplierName, this.status = 'pending', this.blindReceiving = false, this.createdAt, final  List<PoItem> items = const []}): _items = items;
...
@override@JsonKey() List<PoItem> get items {
...
@override
int get hashCode => Object.hash(runtimeType,id,poNumber,supplierId,supplierName,status,blindReceiving,createdAt,const DeepCollectionEquality().hash(_items));
...
/// Create a copy of PurchaseOrder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? poNumber = null,Object? supplierId = freezed,Object? supplierName = freezed,Object? status = null,Object? blindReceiving = null,Object? createdAt = freezed,Object? items = null,}) {
