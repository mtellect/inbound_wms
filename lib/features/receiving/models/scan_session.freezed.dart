...
mixin _$ScanSession {
  ...
  $ScanSessionCopyWith<ScanSession> get copyWith =>
      _$ScanSessionCopyWithImpl<ScanSession>(this as ScanSession, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.totalUnitsExpected, totalUnitsExpected) ||
                other.totalUnitsExpected == totalUnitsExpected) &&
            (identical(other.totalUnitsScanned, totalUnitsScanned) ||
                other.totalUnitsScanned == totalUnitsScanned) &&
...
abstract mixin class $ScanSessionCopyWith<$Res> {
  factory $ScanSessionCopyWith(
          ScanSession value, $Res Function(ScanSession) _then) =
      _$ScanSessionCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String shipmentId,
...
/// @nodoc
class _$ScanSessionCopyWithImpl<$Res> implements $ScanSessionCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? totalUnitsExpected = null,
    Object? totalUnitsScanned = null,
    ...
    return _then(_self.copyWith(
      ...
      operatorId: null == operatorId
          ...
          : operatorId // ignore: cast_nullable_to_non_nullable
              as String,
      totalUnitsExpected: null == totalUnitsExpected
          ? _self.totalUnitsExpected
          : totalUnitsExpected // ignore: cast_nullable_to_non_nullable
              as int,
      totalUnitsScanned: null == totalUnitsScanned
          ? _self.totalUnitsScanned
          : totalUnitsScanned // ignore: cast_nullable_to_non_nullable
              as int,
    ...
    switch (_that) {
      case _ScanSession() when $default != null:
        return $default(
            ...
            _that.supplierName,
            _that.operatorId,
            _that.totalUnitsExpected,
            _that.totalUnitsScanned,
            _that.discrepancies,
            _that.startTime,
            _that.endTime,
            _that.status);
...
class _ScanSession implements ScanSession {
  const _ScanSession(
      ...
      required this.totalUnitsExpected,
      required this.totalUnitsScanned,
  ...
  @override
  final int totalUnitsExpected;
  @override
  final int totalUnitsScanned;
  @override
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ScanSessionCopyWith<_ScanSession> get copyWith =>
      __$ScanSessionCopyWithImpl<_ScanSession>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ScanSession &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.shipmentId, shipmentId) ||
                other.shipmentId == shipmentId) &&
            (identical(other.supplierName, supplierName) ||
...
/// @nodoc
abstract mixin class _$ScanSessionCopyWith<$Res>
    implements $ScanSessionCopyWith<$Res> {
  factory _$ScanSessionCopyWith(
          _ScanSession value, $Res Function(_ScanSession) _then) =
      __$ScanSessionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$ScanSessionCopyWithImpl<$Res> implements _$ScanSessionCopyWith<$Res> {
