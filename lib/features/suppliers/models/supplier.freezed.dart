...
mixin _$Supplier {
 ...
 String get id; String get name; String get code; String? get contactName; String? get email; String? get phone;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,code,contactName,email,phone);

@override
String toString() {
  return 'Supplier(id: $id, name: $name, code: $code, contactName: $contactName, email: $email, phone: $phone)';
}
...
@useResult
$Res call({
 String id, String name, String code, String? contactName, String? email, String? phone
});
...
/// Create a copy of Supplier
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? code = null,Object? contactName = freezed,Object? email = freezed,Object? phone = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String code,  String? contactName,  String? email,  String? phone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Supplier() when $default != null:
return $default(_that.id,_that.name,_that.code,_that.contactName,_that.email,_that.phone);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String code,  String? contactName,  String? email,  String? phone)  $default,) {final _that = this;
switch (_that) {
case _Supplier():
return $default(_that.id,_that.name,_that.code,_that.contactName,_that.email,_that.phone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String code,  String? contactName,  String? email,  String? phone)?  $default,) {final _that = this;
switch (_that) {
case _Supplier() when $default != null:
return $default(_that.id,_that.name,_that.code,_that.contactName,_that.email,_that.phone);case _:
  return null;
...
class _Supplier implements Supplier {
  const _Supplier({required this.id, required this.name, required this.code, this.contactName, this.email, this.phone});
...
/// Create a copy of Supplier
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? code = null,Object? contactName = freezed,Object? email = freezed,Object? phone = freezed,}) {
