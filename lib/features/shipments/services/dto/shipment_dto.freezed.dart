...
mixin _$ShipmentDto {
 ...
 String get id;@JsonKey(name: 'po_id') String get poId;@JsonKey(name: 'carrier_name') String? get carrierName;@JsonKey(name: 'tracking_number') String? get trackingNumber;@JsonKey(name: 'dock_door') String? get dockDoor;@JsonKey(name: 'arrival_time') DateTime? get arrivalTime; String get status;
...
@useResult
$Res call({
 String id,@JsonKey(name: 'po_id') String poId,@JsonKey(name: 'carrier_name') String? carrierName,@JsonKey(name: 'tracking_number') String? trackingNumber,@JsonKey(name: 'dock_door') String? dockDoor,@JsonKey(name: 'arrival_time') DateTime? arrivalTime, String status
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'po_id')  String poId, @JsonKey(name: 'carrier_name')  String? carrierName, @JsonKey(name: 'tracking_number')  String? trackingNumber, @JsonKey(name: 'dock_door')  String? dockDoor, @JsonKey(name: 'arrival_time')  DateTime? arrivalTime,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShipmentDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'po_id')  String poId, @JsonKey(name: 'carrier_name')  String? carrierName, @JsonKey(name: 'tracking_number')  String? trackingNumber, @JsonKey(name: 'dock_door')  String? dockDoor, @JsonKey(name: 'arrival_time')  DateTime? arrivalTime,  String status)  $default,) {final _that = this;
switch (_that) {
case _ShipmentDto():
return $default(_that.id,_that.poId,_that.carrierName,_that.trackingNumber,_that.dockDoor,_that.arrivalTime,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'po_id')  String poId, @JsonKey(name: 'carrier_name')  String? carrierName, @JsonKey(name: 'tracking_number')  String? trackingNumber, @JsonKey(name: 'dock_door')  String? dockDoor, @JsonKey(name: 'arrival_time')  DateTime? arrivalTime,  String status)?  $default,) {final _that = this;
switch (_that) {
case _ShipmentDto() when $default != null:
return $default(_that.id,_that.poId,_that.carrierName,_that.trackingNumber,_that.dockDoor,_that.arrivalTime,_that.status);case _:
  return null;
...
class _ShipmentDto implements ShipmentDto {
  const _ShipmentDto({required this.id, @JsonKey(name: 'po_id') required this.poId, @JsonKey(name: 'carrier_name') this.carrierName, @JsonKey(name: 'tracking_number') this.trackingNumber, @JsonKey(name: 'dock_door') this.dockDoor, @JsonKey(name: 'arrival_time') this.arrivalTime, this.status = 'expected'});
...
@override@JsonKey(name: 'carrier_name') final  String? carrierName;
@override@JsonKey(name: 'tracking_number') final  String? trackingNumber;
@override@JsonKey(name: 'dock_door') final  String? dockDoor;
